...
public class ArmPivotIO_Real implements ArmPivotIO {
    ...
    private MotionMagicVoltage motionMagicVoltage = new MotionMagicVoltage(Constants.ArmPivotConstants.initialSetpoint);
   ...
   public ArmPivotIO_Real() {
    ...
    motorConfigs.Feedback.SensorToMechanismRatio =
       Constants.ArmPivotConstants.gearRatio;
   ...
   public void updateInputs(ArmPivotIOInputs inputs) {
    ...
    inputs.kPosition = pivotMotor.getPosition().getValueAsDouble() * 360; //TODO: Log degrees instead of mechanism rotations
   ...
   public void changeSetpoint(double setpoint) {
    kSetpoint = setpoint + MathUtil.clamp(setpoint, Constants.ArmPivotConstants.initialSetpoint, Constants.ArmPivotConstants.maxStepoint); //TODO: needs clamping
   }
